...
public class ScienceQuestionPanelController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        int noOfQuestions = findNoOfQuestionsFromScience();
        Random rand = new Random();

        int randomNoInRange = 1 + rand.nextInt(noOfQuestions);
        try {
            chooseQuestionsFromScience(randomNoInRange);
    ...
    public void chooseQuestionsFromScience(int indexOfQuestion) throws SQLException {
        DatabaseConnection connectDatabaseNow = new DatabaseConnection();
        String query = "SELECT username, wronganswer1, wronganswer2, wronganswer3, correctanswer, question FROM sciencequestions WHERE idsciencequestions = ?";
